...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2023 at 04:00 PM
...
CREATE DATABASE web_booking_ticket;
USE web_booking_ticket;
...
INSERT INTO `admin` (`MatKhau`, `TaiKhoan`, `MaAdmin`) VALUES
('123456', 'admin', 'admin01');
...
(1, '2023-04-20', 'mario01', 'KH01', 170),
(2, '2023-04-20', 'mario01', 'KH02', 70),
(3, '2023-04-22', 'mario01', 'hailoi@gmail.com', 219),
(4, '2023-04-22', 'mario01', 'hailoi@gmail.com', 140),
(5, '2023-04-22', 'antmanq101', 'hongson@gmail.com', 180),
(6, '2023-04-22', 'marioq101', 'hongson@gmail.com', 228);
...
('$2b$10$9.fXq5P7POQRaKOs687QMukscK/AmIIgGEv5bjoHO4OKA8OQ5gNjq', 'truong thanh loi', 'user', 'hailoi@gmail.com'),
('$2b$10$gA1l86y/1Z5EOJNrAQ.GVe/1zItIVwjRHXnVirwj.WZk16KpU2RZG', 'hongson', 'user', 'hongson@gmail.com'),
('123456', 'truong thanh loi', 'user', 'KH01'),
('123456', 'hong son', 'user', 'KH02'),
('$2b$10$f1A5a5txb2F7lDvir2eftOrfJaQ9f06ZAOOpQxRyuIVOM8RNUdRyW', 'vinhdat', 'user', 'vinhdat@gmail.com');
...
INSERT INTO `khachhang_dichvu` (`NgayDat`, `MaKhachHang`, `MaDichVu`) VALUES
('2023-04-22', 'hailoi@gmail.com', 'combo01'),
('2023-04-22', 'hongson@gmail.com', 'combo01');
...
('antmanq101', 90, 13, '2023-04-22', '20:00', 'Rap 3', '640146', 'cinema01'),
('antmanq701', 90, 13, '2023-04-22', '19:00', 'Rap 5', '640146', 'cinema07'),
('mario01', 70, 12, '2023-04-20', '13:30', 'Rap 1', '502356', 'cinema07'),
('mario02', 90, 12, '2023-04-20', '19:00', 'Rap 2', '502356', 'cinema07'),
('marioq101', 70, 0, '2023-04-22', '17:00', 'Rap 1', '502356', 'cinema01'),
('shazam01', 90, 13, '2023-04-22', '19:00', 'Rap 3', '594767', 'cinema07'),
('shazam02', 90, 13, '2023-04-22', '21:00', 'Rap 2', '594767', 'cinema01');
